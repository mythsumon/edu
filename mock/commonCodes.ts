...
// Title: 학교급_구분
export const schoolLevelTypeTitle: Title = {
  id: 'title-school-level-type',
  name: '학교급_구분',
  status: 'Active',
  groupCount: 1,
  createdAt: '2024-01-10',
...
// Groups: 학교급_구분 (단일 그룹)
export const schoolLevelTypeGroups: Group[] = [
  {
    id: 'school-level-type-group',
    titleId: 'title-school-level-type',
    name: '학교급_구분',
    code: 'SCHOOL_LEVEL',
    status: 'Active',
    valueCount: 6,
...
// Group Keys: 학교급_구분 값들
export const schoolLevelTypeKeys: GroupKey[] = [
  {
    id: 'key-school-level-1',
    groupId: 'school-level-type-group',
    label: '초등',
    value: 'ELEMENTARY',
    sortOrder: 1,
    enabled: true,
