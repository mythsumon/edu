...
export function getEducationSubmissionGroups(): EducationSubmissionGroup[] {
  ...
  return summaries.map(summary => ({
    ...
    lessonPlan: summary.lessonPlan ? {
      id: summary.lessonPlan.id,
      type: 'lessonPlan',
      educationId: summary.educationId,
      status: summary.lessonPlan.status,
      submittedAt: summary.lessonPlan.submittedAt,
      submittedBy: summary.instructorName,
      rejectReason: summary.lessonPlan.rejectReason,
    } : undefined,
