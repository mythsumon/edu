...
export const InstructorDetailPage = () => {
  ...
  const { data: instructor, isLoading, error } = useInstructorDetailQuery(instructorId)
          ...
          <CardContent className="p-6">
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {statusName || (instructor.enabled ? t('accountManagement.active') : t('accountManagement.inactive'))}
                </div>
              </div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">
                <span>{t('accountManagement.account')}: {instructor.username}</span>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{instructor.id}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{instructor.username}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{instructor.name}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{instructor.email || '-'}</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{instructor.phone || '-'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{getGenderLabel(instructor.gender)}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{formatDateOfBirth(instructor.dob)}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{instructor.affiliation || '-'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{instructor.city || '-'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{zoneName || '-'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{regionName || '-'}</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{instructor.street || '-'}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-foreground">{instructor.detailAddress || '-'}</p>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <div
                          className={cn(
                            ...
                            classificationName.toLowerCase().includes('일반')
                              ? 'bg-blue-500'
                              : classificationName.toLowerCase().includes('advanced') ||
                                  classificationName.toLowerCase().includes('고급')
                                ? 'bg-purple-500'
                                : classificationName.toLowerCase().includes('preparation') ||
