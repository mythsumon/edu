export const ROUTES = {
  ...
  ADMIN_ACCOUNT_MANAGEMENT_ADMINS_DETAIL: ':id',
  ADMIN_ACCOUNT_MANAGEMENT_ADMINS_EDIT: ':id/edit',
  ...
  ADMIN_ACCOUNT_MANAGEMENT_ADMINS_DETAIL_FULL: '/admin/account-management/admins/:id',
  ADMIN_ACCOUNT_MANAGEMENT_ADMINS_EDIT_FULL: '/admin/account-management/admins/:id/edit',
