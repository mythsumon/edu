  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 4px 16px rgba(255, 138, 101, 0.12), 0 2px 6px rgba(255, 138, 101, 0.16)',
        'peach': '0 4px 20px rgba(255, 138, 101, 0.12)',
        'peach-lg': '0 8px 32px rgba(255, 138, 101, 0.15)',
        'sm': '0 1px 2px rgba(255, 138, 101, 0.08)',
        'md': '0 2px 8px rgba(255, 138, 101, 0.1)',
        'lg': '0 4px 16px rgba(255, 138, 101, 0.12)',
        'xl': '0 8px 24px rgba(255, 138, 101, 0.14)',
        '2xl': '0 12px 32px rgba(255, 138, 101, 0.16)',
      },
    },
  },
  plugins: [],
