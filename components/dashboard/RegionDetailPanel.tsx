    ...
    <div className="p-4 lg:p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-xl font-bold text-gray-900">{region.name} 교육 진행 현황</h3>
      ...
      {/* 자치단체 Table */}
      <div className="mb-6">
        <h4 className="text-lg font-semibold text-gray-900 mb-4">자치단체별 현황</h4>
      ...
      {/* Summary Table */}
      <div>
        <h4 className="text-lg font-semibold text-gray-900 mb-4">요약</h4>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
