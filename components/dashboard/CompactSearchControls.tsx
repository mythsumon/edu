    ...
    <div className="w-full md:w-[280px] lg:w-[300px] flex-shrink-0">
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 md:p-5 sticky top-4">
        ...
        {onBack && (
          <button
            onClick={onBack}
            className="w-full mb-4 flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-sm font-medium transition-colors"
          >
        ...
        <div className="border-t border-slate-200 pt-4">
          <button
            ...
            className="w-full flex items-center justify-between text-xs font-medium text-slate-600 hover:text-slate-900 mb-2"
          >
            <span>추가 필터</span>
