...
const baseInputClassName = 'h-12 text-base [&_.ant-input-wrapper]:!flex [&_.ant-input-wrapper]:!items-center [&_.ant-input-wrapper]:!h-12 [&_.ant-input-wrapper]:!rounded-lg [&_.ant-input-wrapper]:!bg-white [&_.ant-input-wrapper]:!border [&_.ant-input-wrapper]:!border-[#ffeae0] [&_.ant-input-wrapper]:!transition-all [&_.ant-input-wrapper]:!duration-200 [&_.ant-input]:!bg-transparent [&_.ant-input]:!border-0 [&_.ant-input]:!rounded-lg [&_.ant-input]:!h-12 [&_.ant-input]:!text-[#3a2e2a] [&_.ant-input]:!leading-normal [&_.ant-input]:!py-0 [&_.ant-input]:!pt-0 [&_.ant-input]:!pb-0 [&_.ant-input]:!px-4 [&_.ant-input]:!m-0 [&_.ant-input]:!outline-none [&_.ant-input]:!appearance-none [&_.ant-input]:!-webkit-appearance-none [&_.ant-input::placeholder]:!text-[#8d7c77] [&_.ant-input-prefix]:!flex [&_.ant-input-prefix]:!items-center [&_.ant-input-prefix]:!justify-center [&_.ant-input-prefix]:!h-full [&_.ant-input-prefix]:!w-11 [&_.ant-input-prefix]:!flex-shrink-0 [&_.ant-input-prefix]:!mr-0 [&_.ant-input-suffix]:!flex [&_.ant-input-suffix]:!items-center [&_.ant-input-suffix]:!justify-center [&_.ant-input-suffix]:!h-full'
