...
export interface Education {
  ...
  studentCount?: number // 학생 수 (정산 계산용)
  note?: string
...
const defaultEducations: Education[] = [
    ...
    lessons: [
      {
        ...
        startTime: '09:00',
        endTime: '10:40',
        mainInstructors: [{ id: 'instructor-1', name: '홍길동', status: 'confirmed' }],
        mainInstructorRequired: 1,
        assistantInstructors: [{ id: 'instructor-2', name: '김보조', status: 'confirmed' }],
  ...
  // 같은 날 여러 기관 방문 테스트 데이터 (2025-03-15)
  {
    key: '13',
    status: '확정',
    ...
    lessons: [
      {
        ...
        startTime: '09:00',
        endTime: '10:40',
        mainInstructors: [{ id: 'instructor-2', name: '김보조', status: 'confirmed' }],
        mainInstructorRequired: 1,
        assistantInstructors: [],
        assistantInstructorRequired: 0,
      },
...
let instructorAssignments: InstructorAssignment[] = [
  ...
  // 김보조 강사 - 동일 날짜 3곳 방문 배정 데이터
  {
    key: '10',
    educationId: 'EDU-2025-401',
    educationName: '블록코딩 기초 교육 A',
    institution: '수원초등학교',
    region: '수원시',
    gradeClass: '3학년 1반',
    period: '2025-03-15 ~ 2025-03-15',
  ...
  // 홍길동 강사 - 같은 날 3개 기관 방문 테스트 데이터 (2025-03-15)
  {
    key: '13',
    educationId: 'EDU-2025-301',
    educationName: '8차시 블록코딩 기초 교육',
    institution: '수원초등학교',
    region: '수원시',
    gradeClass: '4학년 1반',
    period: '2025-03-15 ~ 2025-03-15',
    ...
    assistantInstructorRequired: 0,
    program: '블록코딩 기초',
    description: '8차시 블록코딩 기초 교육',
    approvalStatus: '승인됨',
    status: '진행중',
    note: '같은 날 여러 기관 방문 테스트 - 1번째 기관 (수원초등학교)',
    lessons: [
      {
        session: 1,
        date: '2025-03-15',
  ...
  },
  {
    ...
    assistantInstructorRequired: 0,
    program: '스크래치 프로그래밍',
    description: '8차시 스크래치 프로그래밍',
    approvalStatus: '승인됨',
    status: '진행중',
    note: '같은 날 여러 기관 방문 테스트 - 2번째 기관 (성남초등학교)',
    lessons: [
      {
        session: 1,
        date: '2025-03-15',
  ...
  },
  {
    ...
    assistantInstructorRequired: 0,
    program: 'AI 체험',
    description: '8차시 AI 체험 교육',
    approvalStatus: '승인됨',
    status: '진행중',
    note: '같은 날 여러 기관 방문 테스트 - 3번째 기관 (용인초등학교)',
    lessons: [
      {
        session: 1,
        date: '2025-03-15',
