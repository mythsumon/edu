  ...
  return (
    <div className="p-6">
      ...
      <div className="space-y-6">
        <div className="rounded-2xl bg-white border border-gray-200 shadow-sm p-5 md:p-6 flex flex-col gap-4">
          <div className="flex flex-col gap-2 items-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#3a2e2a] leading-tight text-center">2025 소프트웨어(SW) 미래채움 교육 출석부</h2>
          </div>
        </div>
      ...
      <div className="flex gap-6">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {isEditMode && (
              <Button
                ...
                onClick={() => {
                  // In a real app, you would add logic to add a new instructor
                }}
        ...
        <div ref={(el) => { sectionRefs.current['student'] = el }}>
        <Card className="rounded-xl shadow-sm border border-gray-200">
          <div className="flex items-center justify-between mb-4">
