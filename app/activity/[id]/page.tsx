...
import { ArrowLeft, Save, Trash2, Upload as UploadIcon, Image as ImageIcon } from 'lucide-react'
...
export default function ActivityDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <PageTitle
        title={data.title}
        subtitle={`프로그램명: ${data.institutionName} | 교육기관: ${data.institutionName} | ${data.grade}학년 ${data.class}반`}
        actions={
          !isEditMode ? (
            <>
              <Button
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditMode && (
                <Button
                  ...
                  className="h-9 px-4 rounded-lg bg-blue-600 hover:bg-blue-700 border-0"
                >
                  차시 추가
                </Button>
              )}
