  ...
  return (
    <ProtectedRoute requiredRole="admin">
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">강사 관리</h1>
        {viewMode === 'list' ? (
          <Space>
        ...
        <div className="space-y-4">
          ...
          <Card className="rounded-xl shadow-sm border border-gray-200">
            <Table
              ...
              className="[&_.ant-table-thead>tr>th]:bg-gray-50 [&_.ant-table-thead>tr>th]:sticky [&_.ant-table-thead>tr>th]:top-0 [&_.ant-table-thead>tr>th]:z-10 [&_.ant-table-tbody>tr]:border-b [&_.ant-table-tbody>tr]:border-gray-100"
              onRow={(record) => ({
