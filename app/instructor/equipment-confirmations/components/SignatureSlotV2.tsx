...
interface SignatureSlotV2Props {
  label: string
  signature?: Signature
  signerName: string
...
export function SignatureSlotV2({
  label,
  signature,
  signerName,
  onApply,
  ...
  const handleOpenModal = () => {
    if (signature) {
      setTempUrl(signature.signatureImageUrl)
      setTempName(signature.signedByUserName)
